INSERT INTO CATEGORY (ID, NAME, DELETED_AT, VERSION)
VALUES (8723654912736489123, 'Books', NULL, 0);

INSERT INTO CATEGORY (ID, NAME,  DELETED_AT, VERSION)
VALUES (8723654912736489124, 'Electronics', NULL, 0);

INSERT INTO CATEGORY (ID, NAME,  DELETED_AT, VERSION)
VALUES (8723654912736489125, 'Groceries', NULL, 0);
...
INSERT INTO ARTICLE (ID, TITLE, CATEGORY_ID, RATING, VOTE_COUNT,  PUBLISHED_AT, DELETED_AT, STATUS, VERSION)
VALUES
  (1, 'Understanding Event Sourcing', 8723654912736489124, 4.7, 10,  TIMESTAMP '2025-10-06 10:00:00',  NULL, 1, 0),
  (2, 'Spring Data JDBC Deep Dive', 8723654912736489123, 4.5, 5, TIMESTAMP '2025-10-06 11:00:00',  NULL, 1, 0),
  (3, 'Soft Deletes and Versioning Strategies', 8723654912736489123, 4.8, 8, TIMESTAMP '2025-10-06 12:00:00', NULL, 1, 0);
