...
import static com.example.plain.jdbc.persistence.CategoryRepositoryHelper.*;
...
public class CategoryRowMapper implements RowMapper<CategoryEntity> {
  ...
  public CategoryEntity mapRow(ResultSet rs, int rowNum) throws SQLException {
    ...
    final Instant updatedAt = Objects.nonNull(rs.getTimestamp(UPDATED_AT_COLUMN_NAME))
      ? rs.getTimestamp(UPDATED_AT_COLUMN_NAME).toInstant()
      :null;
    ...
    return new CategoryEntity(id, name, updatedAt, deletedAt, version);
  }
}
